...
// Free-text by design: picking a suggestion sets doctorId (linking the reminder
// to the real Doctor record), but typing a name that isn't in the directory and
// never selecting anything just leaves doctorId unset — the reminder still saves
// with doctorName alone (reminder.model.ts's doctorId is optional/nullable for
